...
class MOMADataset(Dataset):
    ...
    def __getitem__(self,index):
        ...
        for counter,frame in enumerate(range(start,end+1)):
            ...
            if frame >=0:
                path_to_image=os.path.join('/home/nicolas_gossard/moma_data/frame_data',str(trim_video_id),str(frame)+'.jpg')
        ...
        stacked_encoding=[np.zeros((53)) for _ in range(16)]
        for index,encoding_frame in enumerate(aact_labels):
            encoding=one_hot(encoding_frame,53)
